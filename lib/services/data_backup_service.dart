...
class DataBackupService {
  static Future<void> exportData() async {
    ...
    final sharedPrefsData =
        prefs.getKeys().fold<Map<String, dynamic>>({}, (map, key) {
    ...
    try {
      ...
      if (data['app'] != 'WeatherMaster' ||
        ...
        SnackUtil.showSnackBar(
            context: context, message: "Invalid backup file format.");
        return;
      }
      ...
      final sharedPrefsData =
          Map<String, dynamic>.from(data['sharedPreferences'] ?? {});
      ...
      SnackUtil.showSnackBar(
          context: context, message: "Import complete. Restarting app");
