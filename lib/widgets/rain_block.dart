...
bool willRainStopSoon() {
  ...
  String? generateSummary(int? start, int? end) {
    ...
    final unitSettings = Provider.of<UnitSettingsNotifier>(context, listen: false);
        ...
        children: [
          ...
          if (subtitle != null)
            Padding(
              ...
              child: Text(subtitle, style: TextStyle(color: Theme.of(context).colorScheme.onSurfaceVariant, fontSize: 13)),
            ),
      ...
      final convertedPrecip = precipitationUnit == 'cm'
        ...
        return BarTooltipItem(
          '${convertedPrecip.toStringAsFixed(1)} $precipitationUnit',
           TextStyle(color: Theme.of(context).colorScheme.onPrimaryContainer, fontWeight: FontWeight.w500),
        ...
        bottomTitles: AxisTitles(
          sideTitles: SideTitles(
            ...
            getTitlesWidget: (value, _) {
              ...
              if (idx % 3 != 0 || idx >= next12Time.length) return const SizedBox.shrink();
