            ...
            return CustomScrollView(
              slivers: [
                SliverAppBar.large(
                  ...
                  const SliverFillRemaining(
                    child: Center(child: Text("No saved locations available.")),
                  )
                else
                  SliverList(
            ...
            child: ListTile(
              ...
              leading: isSelected
                  ? Stack(
                      ...
                      children: [
                        SvgPicture.string(buildSvg(Theme.of(context).colorScheme.primary)),
                  ...
                  : Stack(
                      alignment: Alignment.center,
                      children: [
                        SvgPicture.string(buildSvg(Theme.of(context).colorScheme.tertiary)),
                        Icon(Icons.my_location, color: Theme.of(context).colorScheme.onTertiary),
                      ],
                    ),
              title: Text(
        ...
        return;
                  ...
                  return Padding(
                    ...
                    child: Container(
                      ...
                      child: ListTile(
                        contentPadding: EdgeInsets.only(left: 5, right: 20),                        
                        enabled: thisCacheKey == currentCacheKey ? false : true,
                        minTileHeight: 68,
                        splashColor: Colors.transparent,
                        leading: isSelected                         
                            ? Stack(
                            ...
                            : Stack(
                              ...
                              children: [
                                SvgPicture.string(buildSvg(Theme.of(context).colorScheme.tertiary) ),
                                Icon(Icons.location_on, color: Theme.of(context).colorScheme.onTertiary),
                              ],
                            ), 
                        title: Text(
                          loc.city,
                          style: TextStyle(fontWeight: FontWeight.w500, color: isSelected ? Theme.of(context).colorScheme.onPrimaryContainer : null),
                        ),
