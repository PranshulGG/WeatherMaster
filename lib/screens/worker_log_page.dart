        ...
        SliverToBoxAdapter(
          child: Container(
            ...
            child: _workInfoMap == null
                ? Text(_workInfo) // loading or error message
                : Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: _workInfoMap!.entries.map((entry) {
                      if (entry.value is List) {
                        // For tags list, display as bullets or chips
                        return Padding(
                        ...
                        // Skip boolean flags or just ignore
                        ...
                        return Padding(
                          ...
                          child: RichText(
                            ...
                            text: TextSpan(
                              ...
                              style: TextStyle(color: entry.value.toString() == "CANCELLED" ? Theme.of(context).colorScheme.error : Theme.of(context).colorScheme.onSurface, fontSize: 16),
                              children: [
                                TextSpan(
                                  text: "${entry.key}: ",
