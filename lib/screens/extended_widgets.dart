   ...
   children: [ 
      ...
      height: 360,
       ...
       child:  Column(
        crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Text("todays_avg".tr(), style: TextStyle(fontSize: 20,  color: Theme.of(context).colorScheme.onSurface, fontWeight: FontWeight.w500)),
            Text("$avgHumidity%", style: TextStyle(fontSize: 50,  color: Theme.of(context).colorScheme.secondary, fontWeight: FontWeight.w500),)
            ...
            return Container(
              ...
              child: Column(
                ...
                children: [
                      ...
                      child: SizedBox(
                        ...
                        child: Stack(
                          ...
                          children: [
                            ...
                            child: SizedBox(
                              height: 48,
                              child: Icon(Symbols.humidity_high, color: Theme.of(context).colorScheme.onPrimaryContainer, size: 18,),),
                            )
                          ]
                        ),
                      ),
                  ...
                  Text("$humidityPercentage%", style: TextStyle(fontSize: 14, color: Theme.of(context).colorScheme.onSurfaceVariant, fontWeight: FontWeight.w500)),
    ...
    Container(
     ...
     child:  Column(  
      spacing: 20,
        children: [
          Text("humidity_info".tr(), style: TextStyle(fontSize: 17, color: Theme.of(context).colorScheme.onSurfaceVariant, fontWeight: FontWeight.w500)),
          Text("humidity_info_2".tr(), style: TextStyle(fontSize: 17, color: Theme.of(context).colorScheme.onSurfaceVariant, fontWeight: FontWeight.w500)),
        ],
      )
      )
...
String formatInstantToLocalTime(Instant instant, {String timeUnit = '24 hr'}) {
  ...
  final formatter = timeUnit == '24 hr' ? DateFormat.Hm() : DateFormat.jm();

  return formatter.format(dateTime);
}

  final calc = SolarCalculator(instant, weather['latitude'], weather['longitude']);

  final timeFormatDUSKDAWN = timeUnit == '24 hr' ? DateFormat.Hm() : DateFormat.jm();

  final dawn = calc.morningCivilTwilight.begining;
  final dusk = calc.eveningCivilTwilight.ending;


final dawnFormatted = formatInstantToLocalTime(dawn, timeUnit: timeFormatDUSKDAWN.toString());
final duskFormatted = formatInstantToLocalTime(dusk, timeUnit: timeFormatDUSKDAWN.toString());
  ...
  final sunriseWidget = Column(
    crossAxisAlignment: CrossAxisAlignment.center,
    children: [
      Text("sunrise".tr(), style: TextStyle(color: Theme.of(context).colorScheme.primary, fontWeight: FontWeight.w500, fontSize: 15)),
      Text(sunriseFormat, style: TextStyle(color: Theme.of(context).colorScheme.primary, fontWeight: FontWeight.w500, fontSize: 18)),
    ],
  );
  ...
  final sunsetWidget = Column(
    crossAxisAlignment: CrossAxisAlignment.center,
    children: [
      Text("sunset".tr(), style: TextStyle(color: Theme.of(context).colorScheme.secondary, fontWeight: FontWeight.w500, fontSize: 15)),
      Text(sunsetFormat, style: TextStyle(color: Theme.of(context).colorScheme.secondary, fontWeight: FontWeight.w500, fontSize: 18)),
    ],
  );
  return Column(
    children: [
                ...
                isSmallScreen
                  ? Column(
                    ...
                    : Row(
                        ...
                        children: [dawnWidget, sunriseWidget, duskWidget, sunsetWidget],
                  ),
            Container(
              margin: EdgeInsets.fromLTRB(12, 20, 12, MediaQuery.of(context).padding.bottom + 26),
              padding: EdgeInsets.all(20),
              ...
              spacing: 20,
                children: [
                  Text("sunset_rise_info".tr(), style: TextStyle(fontSize: 17, color: Theme.of(context).colorScheme.onSurfaceVariant, fontWeight: FontWeight.w500)),
                  Text("sunset_rise_info_2".tr(), style: TextStyle(fontSize: 17, color: Theme.of(context).colorScheme.onSurfaceVariant, fontWeight: FontWeight.w500)),
                  Text("sunset_rise_info_3".tr(), style: TextStyle(fontSize: 17, color: Theme.of(context).colorScheme.onSurfaceVariant, fontWeight: FontWeight.w500)),
                  Text("sunset_rise_info_4".tr(), style: TextStyle(fontSize: 17, color: Theme.of(context).colorScheme.onSurfaceVariant, fontWeight: FontWeight.w500)),
                ],
              )
          )
        ]
   ...
   children: [ 
      ...
      height: 360,
       ...
       child:  Column(
        crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Text("current_conditions".tr(), style: TextStyle(fontSize: 20,  color: Theme.of(context).colorScheme.onSurface, fontWeight: FontWeight.w500)),
            Row(
       ...
       SizedBox(
        ...
        child: ListView.builder(
          ...
          final roundedDisplayTime = DateTime(
            ...
            final pressurePercentage = ((currentPressure - minPressure) / (maxPressure - minPressure)) * 100;
        ...
        if (dataIndex > 0) {
          final previousPressure = hourlyPressure[dataIndex - 1];
          final pressureDifference = currentPressure - previousPressure;

          if (pressureDifference > 0.5) {
            pressureTrendIcon = Icon(Symbols.arrow_upward, size: 18, color: Theme.of(context).colorScheme.onPrimaryContainer, weight: 600);
            pressureprimary = Theme.of(context).colorScheme.primaryContainer;
          } else if (pressureDifference < -0.5) {
            pressureTrendIcon = Icon(Symbols.arrow_downward, size: 18, color: Theme.of(context).colorScheme.onError, weight: 600);
            pressureprimary = Theme.of(context).colorScheme.error;
          } else {
            pressureTrendIcon = Icon(Symbols.trending_flat, size: 18, color: Theme.of(context).colorScheme.onSurfaceVariant, weight: 600);
            pressureprimary = Theme.of(context).colorScheme.surfaceContainerLowest;
          }
        }
            ...
            return Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text("${pressureHourly[dataIndex].round()}", style: TextStyle(fontSize: 14, color: Theme.of(context).colorScheme.onSurfaceVariant, fontWeight: FontWeight.w500)),
                  Text(hour, style: TextStyle(fontSize: 15, color: Theme.of(context).colorScheme.onSurface, fontWeight: FontWeight.w500)),
                ],
              ),
              );
      ...
      Container(
              ...
              spacing: 20,
                children: [
                  Text("pressure_info".tr(), style: TextStyle(fontSize: 17, color: Theme.of(context).colorScheme.onSurfaceVariant, fontWeight: FontWeight.w500)),
                  Text("pressure_info_2".tr(), style: TextStyle(fontSize: 17, color: Theme.of(context).colorScheme.onSurfaceVariant, fontWeight: FontWeight.w500)),
                ],
              )
          )
        ]
        ...
        children: [
          ...
          children: [
            ...
            Row(
              ...
              spacing: 20,
                children: [
                  Text("visibility_info".tr(), style: TextStyle(fontSize: 17, color: Theme.of(context).colorScheme.onSurfaceVariant, fontWeight: FontWeight.w500)),
                ],
              )
          )
        ]
   ...
   children: [ 
      ...
      height: 360,
       ...
       SizedBox(
        ...
        final windPercentage = ((windSpeed - minWind) / (maxWind - minWind)) * 100;
    ...
    final windUnit = PreferencesHelper.getString("selectedWindUnit") ?? 'Km/h';
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    clipBehavior: Clip.none,
                        width: 43,
                        height: math.max((windPercentage / 100) * 160, 48), 
                        decoration: BoxDecoration(
                          color: Theme.of(context).colorScheme.primary,
                          borderRadius: BorderRadius.circular(50),
                        ),
      ...
      Container(
              ...
              spacing: 20,
                children: [
                  Text("wind_info".tr(), style: TextStyle(fontSize: 17, color: Theme.of(context).colorScheme.onSurfaceVariant, fontWeight: FontWeight.w500)),
                ],
              )
          )
        ]
   ...
   children: [ 
    ...
    SizedBox(
                      ...
                      child: SizedBox(
                        ...
                        child: Stack(
                          ...
                          children: [
                            ...
                            child: SizedBox(
                              height: 48,
                              child: Icon(Symbols.sunny, color: Theme.of(context).colorScheme.onPrimary, fill: 1, size: 20,),
                            )
                            )
                          ]
                        ),
      ...
      Container(
              ...
              spacing: 20,
                children: [
                  Text("uv_index_info".tr(), style: TextStyle(fontSize: 17, color: Theme.of(context).colorScheme.onSurfaceVariant, fontWeight: FontWeight.w500)),
                  Text("uv_index_info_2".tr(), style: TextStyle(fontSize: 17, color: Theme.of(context).colorScheme.onSurfaceVariant, fontWeight: FontWeight.w500)),
                  Text("uv_index_info_3".tr(), style: TextStyle(fontSize: 17, color: Theme.of(context).colorScheme.onSurfaceVariant, fontWeight: FontWeight.w500)),
                  Text("uv_index_info_4".tr(), style: TextStyle(fontSize: 17, color: Theme.of(context).colorScheme.onSurfaceVariant, fontWeight: FontWeight.w500)),
                  Text("uv_index_info_5".tr(), style: TextStyle(fontSize: 17, color: Theme.of(context).colorScheme.onSurfaceVariant, fontWeight: FontWeight.w500)),
                ],
              )
          )
        ]
        ...
        crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            ...
            Row(
              crossAxisAlignment: CrossAxisAlignment.end,
              children: [
                Text("$aqiFormat", style: TextStyle(fontSize: 50,  color: Theme.of(context).colorScheme.secondary, fontWeight: FontWeight.w500),),
                Padding(padding: EdgeInsets.only(bottom: 11, left: 8),
               child: Text(getAQIIndexType(aqiFormat, aqiUnit == 'European' ? true : false), style: TextStyle(fontSize: 20,  color: Theme.of(context).colorScheme.onSurfaceVariant, fontWeight: FontWeight.w500),))
              ],
            ),
          ],
        ),
     ...
     child: Column(
        ...
        children: [
          Row(
            ...
            children: [
              Text("${"united_states_aqi".tr()}:", style: TextStyle(color: Theme.of(context).colorScheme.onSurface, fontSize: 15),),
              Container(
                ...
                child: Text("${airQualityData['us_aqi']}", style: TextStyle(color: Theme.of(context).colorScheme.onTertiary, fontSize: 16, fontWeight: FontWeight.w500)),
              )
            ],
          ),
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
              Text("${"european_aqi".tr()}:", style: TextStyle(color: Theme.of(context).colorScheme.onSurface, fontSize: 15)),
              Container(
                padding: EdgeInsets.only(left: 10, right: 10),
                decoration: BoxDecoration(
                  borderRadius: BorderRadius.circular(50),
                ...
                child: Text("${airQualityData['european_aqi']}", style: TextStyle(color: Theme.of(context).colorScheme.onTertiary, fontSize: 16, fontWeight: FontWeight.w500)),
              )
            ],
          )
        ],
