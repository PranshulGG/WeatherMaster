            ...
            child: Column(children: [
                  ...
                  SettingSingleOptionTile(
                    ...
                    onSubmitted: (value) {
                      setState(() {
                        ...
                        themeController.setThemeMode(selectedKey == "Dark"
                            ? ThemeMode.dark
                            : selectedKey == "Auto"
                                ? ThemeMode.system
                                : ThemeMode.light);
                      ...
                      setState(() {
                        ...
                        if (value == true) {
                          Provider.of<ThemeController>(context, listen: false)
                              .setSeedColor(PreferencesHelper.getColor(
                                      "CustomMaterialColor") ??
                                  Colors.blue);
                        } else {
                          Provider.of<ThemeController>(context, listen: false)
              ...
              SettingSection(
                ...
                tiles: [
                  ...
                  SettingSwitchTile(
                    icon: Icon(Symbols.assistant_navigation,
                        fill: 1, weight: 500),
              ...
              SettingSection(
                  ...
                  tiles: [
                    SettingActionTile(
                      ...
                      description: Text(getLanguageNamesSettingsView(
