  ...
  Widget _buildWeatherContent() {
    ...
    return FutureBuilder<Map<String, dynamic>?>(
        ...
        builder: (context, snapshot) {
          ...
          final List<dynamic> alerts = (weather['alerts']?['alert'] as List?) ??
              []; // Get alerts list or empty list if null
          final bool showAlerts =
              alerts.isNotEmpty; // True if there are any alerts
              ...
              case LayoutBlockType.conditions:
                return SizedBox(
                  ...
                  child: ConditionsWidgets(
                    ...
                    timezone: weather['timezone'].toString(),
                    utcOffsetSeconds: weather['utc_offset_seconds'].toString(),
                    currentUvIndex: hourly['uv_index'][getStartIndex(
                            weather['utc_offset_seconds'].toString(),
                            hourlyTime)] ??
                        0.0000001,
