  ...
  if (selectedDayData == null) {
    ...
    return Column(
      ...
      children: [
        ...
        child: Text(formatDateDetailes(selectedDayData!['date']), style: TextStyle(color: Theme.of(context).colorScheme.onSurface, fontSize: 20, fontWeight: FontWeight.w600),)),
