            ...
            return GestureDetector(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text("${tempMin.round()}°", style: TextStyle(fontSize: 16, color: isSelected ? Theme.of(context).colorScheme.onPrimaryFixed : Theme.of(context).colorScheme.onSurfaceVariant, fontWeight: FontWeight.w500)),
                    ],
                  ),
                SvgPicture.asset(
...
//           final temp = convert(hour['temperature']);
//           final iconCode = hour['weatherCode'];
...
//                 Text(time),
//                 SvgPicture.asset(
//                   WeatherIconMapper.getIcon(iconCode, 1),
//                   width: 30,
//                 ),
//                 Text("$temp°"),
//               ],
...
// Replace nowLocal with selectedDate adjusted to the local timezone
final localSelectedDate = selectedDate.toUtc().add(offset);

// Use midnight start for selected day
