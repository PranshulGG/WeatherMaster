  ...
  if (selectedDayData == null) {
    ...
    return Column(
      ...
      children: [
        ...
        child: Text(formatDateDetailes(selectedDayData!['date']), style: TextStyle(color: Theme.of(context).colorScheme.onSurfaceVariant, fontSize: 20, fontWeight: FontWeight.w500),)),
        Padding(padding: EdgeInsets.only(left: 12, right: 12, top: 10),
        child: Text(getCityFromPreferences(), style: TextStyle(color: Theme.of(context).colorScheme.onSurface, fontSize: 24, fontWeight: FontWeight.w500),)),
