  ...
  if (selectedDayData == null) {
    ...
    return Column(
      ...
      children: [
        ...
        child: Text(formatDateDetailes(selectedDayData!['date']), style: TextStyle(color: Theme.of(context).colorScheme.onSurfaceVariant, fontSize: 20, fontWeight: FontWeight.w700),)),
        Padding(padding: EdgeInsets.only(left: 12, right: 12, top: 6),
