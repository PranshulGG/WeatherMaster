  ...
  if (selectedDayData == null) {
    ...
    return Column(
      ...
      children: [
        ...
        Padding(padding: EdgeInsets.only(left: 12, right: 12, top: 24),
        child: Text(PreferencesHelper.getString("currentLocation").toString(), style: TextStyle(color: Theme.of(context).colorScheme.onSurface, fontSize: 24, fontWeight: FontWeight.w500),)),
