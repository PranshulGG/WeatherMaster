          ...
          : HourlyCardForecast(
            ...
            hourlyPrecpProb: hourlyPrecpProb,
              ...
              child: ConditionsWidgets(
                selectedContainerBgIndex: Theme.of(context).colorScheme.surfaceContainerLow.toARGB32(),
                currentHumidity: dailyDates[selectedIndex]['relative_humidity_2m'],
                currentDewPoint: hourly[selectedIndex]['dew_point_2m'][0].toDouble(),
                currentSunrise: daily[selectedIndex]['sunrise'][0],
                currentSunset: daily[selectedIndex]['sunset'][0],
                currentPressure: dailyDates[selectedIndex]['pressure_msl'],
                currentVisibility: hourly[selectedIndex]['visibility'][0],
                currentWindSpeed: dailyDates[selectedIndex]['wind_speed_10m'],
                currentWindDirc: dailyDates[selectedIndex]['wind_direction_10m'],
                timezone: weather['timezone'].toString(),
                utcOffsetSeconds: weather['utc_offset_seconds'].toString(),
                currentUvIndex: hourly[selectedIndex]['uv_index'][0],
                currentTotalPrec: daily[selectedIndex]['precipitation_sum'][0],
              ),
            ),
...
class ConditionsWidgets extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final dewpointConverted = context.watch<UnitSettingsNotifier>().tempUnit == 'Fahrenheit' ? UnitConverter.celsiusToFahrenheit(currentDewPoint.toDouble()).round() : currentDewPoint.toDouble().round();
            ...
            Expanded(
                ...
                ClipRRect(
                  ...
                  child: Container(
                    ...
                    child: Stack(
                      children: [
                        SvgPicture.string(
                          buildHumidity(Theme.of(context).colorScheme.tertiaryContainer, currentHumidity),
                          fit: BoxFit.cover, 
                        ),
                    ListTile(
                      ...
                      child: Align(
                        ...
                        child: Text("$currentHumidity%", 
                        style: TextStyle(
                          color: Theme.of(context).colorScheme.onTertiaryContainer, fontSize: 50, fontWeight: FontWeight.w500),
                          ),
                        )
                      ),
                      Align(
              ...
              WindCompassWidget(currentWindDirc: currentWindDirc, backgroundColor: Color(selectedContainerBgIndex)),
                 ...
                 Align(
                  ...
                  height: 55,
                  child: Text(getWindSpeedType(currentWindSpeed), style: 
