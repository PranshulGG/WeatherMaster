  ...
  if (selectedDayData == null) {
    ...
    return Column(
      ...
      children: [
        ...
        Padding(padding: EdgeInsets.only(left: 12, right: 12),
        child: Row(children: [Text(context.watch<UnitSettingsNotifier>().tempUnit == 'Fahrenheit' ? UnitConverter.celsiusToFahrenheit(selectedDayData!['maxTemp']).round().toString() : selectedDayData!['maxTemp'].round().toString(), style: TextStyle(color: Theme.of(context).colorScheme.onSurface, fontSize: 24, fontWeight: FontWeight.w500)), Text(context.watch<UnitSettingsNotifier>().tempUnit == 'Fahrenheit' ? UnitConverter.celsiusToFahrenheit(selectedDayData!['minTemp']).round().toString() : selectedDayData!['minTemp'].round().toString(), style: TextStyle(color: Theme.of(context).colorScheme.onSurface, fontSize: 24, fontWeight: FontWeight.w500))],)),
