    ...
    weatherData ??= snapshot.data!['data'];
          ...
          : HourlyCardForecast(
            ...
            hourlyPrecpProb: hourlyPrecpProb,
              ...
              selectedContainerBgIndex: Theme.of(context).colorScheme.surfaceContainerLow.toARGB32(),
              currentHumidity: daily['relative_humidity_2m'][selectedIndex],
              currentDewPoint: hourly['dew_point_2m'][selectedIndex].toDouble(),
              currentSunrise: daily['sunrise'][selectedIndex],
              currentSunset: daily['sunset'][selectedIndex],
              currentPressure: daily['pressure_msl'][selectedIndex],
              currentVisibility: hourly['visibility'][selectedIndex],
              currentWindSpeed: daily['wind_speed_10m'][selectedIndex],
              currentWindDirc: daily['wind_direction_10m'][selectedIndex],
              timezone: weather['timezone'].toString(),
              utcOffsetSeconds: weather['utc_offset_seconds'].toString(),
              currentUvIndex: hourly['uv_index'][selectedIndex],
              currentTotalPrec: daily['precipitation_sum'][selectedIndex],
            ),
            ),
