          ...
          itemBuilder: (context, index) {
            ...
            return GestureDetector(
              ...
              child: Column(
                ...
                children: [
                  Text(
                _getDayLabel(time, index, int.parse(utcOffsetSeconds.toString())),
...
String _getDayLabel(DateTime date, int index, int utcOffsetSeconds) {
  ...
  const todayLabel = "Today"; // Or "Now", or localize it

  int offsetSeconds = utcOffsetSeconds;
  ...
  if (target == today) {
    ...
    String shortWeekday = DateFormat('E').format(date); // e.g., "Mon"
    return customDayLabels[shortWeekday] ?? shortWeekday;
  }
}
