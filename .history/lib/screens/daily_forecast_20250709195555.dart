  ...
  if (selectedDayData == null) {
    ...
    return Column(
      ...
      children: [
        ...
        Padding(padding: EdgeInsets.only(left: 12, right: 12),
        child: Row(children: [Text(selectedDayData!['maxTemp'].toString(), style: TextStyle(color: Theme.of(context).colorScheme.onSurface, fontSize: 24, fontWeight: FontWeight.w500))],)),
