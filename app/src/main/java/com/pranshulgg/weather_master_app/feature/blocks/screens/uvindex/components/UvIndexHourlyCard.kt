package com.pranshulgg.weather_master_app.feature.blocks.screens.uvindex.components
...
@Composable
fun UvIndexHourlyCard(data: List<WeatherHourly>, zoneId: String) {
