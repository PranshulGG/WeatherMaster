...
@Composable
fun MoonBlock(weather: Weather, dailyIndex: Int, prefs: AppPrefsState, onClickBlock: () -> Unit) {
            ...
            Surface(
                ...
                Box(Modifier.fillMaxSize()) {
                    ...
                    Column(Modifier.align(Alignment.Center)) {
                        RiseSetTimeRow(moonriseFormatted, R.drawable.arrow_upward_24px) // RISE
                        RiseSetTimeRow(moonsetFormatted, R.drawable.arrow_downward_24px) // SET
                    }
                }
            }
        }
...
private fun Header() {
    Row(
        ...
        Text(
            stringResource(R.string.weather_moon),
