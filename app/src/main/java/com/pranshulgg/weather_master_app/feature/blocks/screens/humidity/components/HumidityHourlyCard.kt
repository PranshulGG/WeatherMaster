...
@Composable
fun HumidityHourlyCard(data: List<WeatherHourly>, zoneId: String) {
            ...
            LazyRow(
                ...
                items(
                    ...
                    val barColor = when {
                        ...
                        item.humidity < 40 -> Color(0xFFF9A825)
                        item.humidity < 60 -> Color(0xFF43A047)
                        item.humidity < 80 -> Color(0xFF1E88E5)
