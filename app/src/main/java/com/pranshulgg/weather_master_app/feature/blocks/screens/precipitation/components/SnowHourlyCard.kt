        ...
        Column(
            ...
            LazyRow(
                ...
                items(
                    ...
                    val item = data[index]
                    val snowFall = item.snowfall ?: 0.0

                    val percentage = ((snowFall.minus(min)).div((max - min))).times(100)
                    ...
                    val barColor = when {
                        ...
                        snowFall < 1.0 -> Color(0xFFB3E5FC)
                        snowFall < 2.5 -> Color(0xFF4FC3F7)
                        snowFall < 7.5 -> Color(0xFF1E88E5)
                        snowFall < 20.0 -> Color(0xFF1565C0)
                        snowFall < 50.0 -> Color(0xFF6A1B9A)
                    ...
                    Column(
                        ...
                        Text(
                            formatLocalizedNumber(
                                getCurrentAppLocale(),
                                formatter(item.snowfall ?: 0.0) ?: 0.0,
                                1
                            ),
