...
public class AboutPage extends AppCompatActivity {
        ...
        webview.setWebViewClient(new WebViewClient() {
            ...
            public void onPageFinished(WebView view, String url) {
                ...
                if (isFirstLoad) {
                    ...
                    int primaryColor = new ContextThemeWrapper(AboutPage.this, R.style.Base_Theme_WeatherMaster)
                            .getTheme()
    ...
    public class NavigateActivityInterface {
        ...
        public void OpenActivity(final String activityName) {
            ...
            switch (activityName) {
                case "OpenContributorsPage":
                    intent = new Intent(mContext, contributorsPage.class);
                    break;
                case "OpenTermsConditions":
                    intent = new Intent(mContext, Terms_Conditions.class);
                    break;
                case "OpenPrivacyPolicy":
                    intent = new Intent(mContext, PrivacyPolicy.class);
                    break;
                case "OpenLicenses":
                    intent = new Intent(mContext, ThirdParty.class);
                    break;
                default:
