...
public class UVIndexCondition extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webview.loadUrl("file:///android_asset/pages/conditions_pages/uvIndex_forecast.html");
        ...
        webview.setWebViewClient(new WebViewClient() {
            ...
            public void onPageFinished(WebView view, String url) {
                ...
                if (isFirstLoad) {
                    ...
                    int primaryColor = new ContextThemeWrapper(UVIndexCondition.this, R.style.Base_Theme_WeatherMaster)
                            .getTheme()
    ...
    public class AndroidFunctionActivityInterface {
        private UVIndexCondition mActivity;

        AndroidFunctionActivityInterface(UVIndexCondition activity) {
            mActivity = activity;
        }
    ...
    public class AndroidInterface {
        ...
        AndroidInterface(UVIndexCondition activity) {
            mActivity = activity;
        }
