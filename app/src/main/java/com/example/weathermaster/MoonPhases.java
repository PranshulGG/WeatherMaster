...
public class MoonPhases extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webview.loadUrl("file:///android_asset/pages/conditions_pages/moon_forecast.html");
        ...
        webview.setWebViewClient(new WebViewClient() {
            ...
            public void onPageFinished(WebView view, String url) {
                ...
                if (isFirstLoad) {
                    ...
                    int primaryColor = new ContextThemeWrapper(MoonPhases.this, R.style.Base_Theme_WeatherMaster)
                            .getTheme()
    ...
    public class AndroidFunctionActivityInterface {
        private MoonPhases mActivity;

        AndroidFunctionActivityInterface(MoonPhases activity) {
            mActivity = activity;
        }
    ...
    public class AndroidInterface {
        ...
        AndroidInterface(MoonPhases activity) {
            mActivity = activity;
        }
