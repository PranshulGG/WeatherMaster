...
public class humidityCondition extends AppCompatActivity {
        ...
        webview.setWebViewClient(new WebViewClient() {
            ...
            public void onPageFinished(WebView view, String url) {
                ...
                if (isFirstLoad) {
                    ...
                    int primaryColor = new ContextThemeWrapper(humidityCondition.this, R.style.Base_Theme_WeatherMaster)
                            .getTheme()
    ...
    public class AndroidFunctionActivityInterface {
        private humidityCondition mActivity;

        AndroidFunctionActivityInterface(humidityCondition activity) {
            mActivity = activity;
        }
    ...
    public class AndroidInterface {
        ...
        AndroidInterface(humidityCondition activity) {
            mActivity = activity;
        }
