...
public class ThirdParty extends AppCompatActivity {
        ...
        webview.setWebViewClient(new WebViewClient() {
            ...
            public void onPageFinished(WebView view, String url) {
                ...
                if (isFirstLoad) {
                    ...
                    int primaryColor = new ContextThemeWrapper(ThirdParty.this, R.style.Base_Theme_WeatherMaster)
                            .getTheme()
    ...
    public class AndroidInterface {
        private ThirdParty thActivity;

        AndroidInterface(ThirdParty activity) {
            thActivity = activity;
        }

        @JavascriptInterface
        public void updateStatusBarColor(final String color) {
            thActivity.runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    if(color.equals("Scrolled")){
                        ...
                        Toast.makeText(thActivity, "Your device will stay awake", Toast.LENGTH_SHORT).show();
                        return;
                    } else if (color.equals("ItsOff")) {
                        Toast.makeText(thActivity, "Your device will go to sleep at the default time", Toast.LENGTH_SHORT).show();
                        return;


                    } else {
                        Toast.makeText(thActivity, "not found", Toast.LENGTH_SHORT).show();
                        return;
                    }


                    int currentStatusBarColor = thActivity.getWindow().getStatusBarColor();
                    int currentNavigationBarColor = thActivity.getWindow().getNavigationBarColor();

                    ObjectAnimator statusBarAnimator = ObjectAnimator.ofObject(
                            thActivity.getWindow(),
                            "statusBarColor",
                            new ArgbEvaluator(),
                    ...
                    thActivity.getWindow().setNavigationBarColor(navigationBarColor);

                    View decorView = thActivity.getWindow().getDecorView();
