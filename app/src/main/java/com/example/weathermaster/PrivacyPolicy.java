...
public class PrivacyPolicy extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webview.loadUrl("file:///android_asset/pages/aboutPages/PrivacyPolicy.html");
        ...
        webview.setWebViewClient(new WebViewClient() {
            ...
            public void onPageFinished(WebView view, String url) {
                ...
                if (isFirstLoad) {
                    ...
                    int primaryColor = new ContextThemeWrapper(PrivacyPolicy.this, R.style.Base_Theme_WeatherMaster)
                            .getTheme()
    ...
    public class AndroidInterface {
        private PrivacyPolicy pActivity;

        AndroidInterface(PrivacyPolicy activity) {
            pActivity = activity;
        }
            ...
            pActivity.runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    if(color.equals("Scrolled")){
                        ...
                        Toast.makeText(pActivity, "Your device will stay awake", Toast.LENGTH_SHORT).show();
                        return;
                    } else if (color.equals("ItsOff")) {
                        Toast.makeText(pActivity, "Your device will go to sleep at the default time", Toast.LENGTH_SHORT).show();
                        return;


                    } else {
                        Toast.makeText(pActivity, "not found", Toast.LENGTH_SHORT).show();
                        return;
                    }


                    int currentStatusBarColor = pActivity.getWindow().getStatusBarColor();
                    int currentNavigationBarColor = pActivity.getWindow().getNavigationBarColor();
                    ...
                    pActivity.getWindow().setNavigationBarColor(navigationBarColor);
