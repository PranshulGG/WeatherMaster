...
public class ForecastPage extends AppCompatActivity {
        ...
        webview.setWebViewClient(new WebViewClient() {
            ...
            public void onPageFinished(WebView view, String url) {
                ...
                if (isFirstLoad) {
                    ...
                    int primaryColor = new ContextThemeWrapper(ForecastPage.this, R.style.Base_Theme_WeatherMaster)
                            .getTheme()
    ...
    public class AndroidInterface {
        private ForecastPage aActivity;

        AndroidInterface(ForecastPage activity) {
            aActivity = activity;
        }
