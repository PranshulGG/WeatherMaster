...
public class sunCondition extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webview.loadUrl("file:///android_asset/pages/conditions_pages/sunset_rise_forecast.html");
        webview.setWebViewClient(new WebViewClient() {
            ...
            public void onPageFinished(WebView view, String url) {
                ...
                if (isFirstLoad) {
                    ...
                    int primaryColor = new ContextThemeWrapper(sunCondition.this, R.style.Base_Theme_WeatherMaster)
                            .getTheme()
    ...
    public class AndroidFunctionActivityInterface {
        private sunCondition mActivity;

        AndroidFunctionActivityInterface(sunCondition activity) {
            mActivity = activity;
        }
    ...
    public class AndroidInterface {
        ...
        AndroidInterface(sunCondition activity) {
            mActivity = activity;
        }
