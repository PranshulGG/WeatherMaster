...
public class visibilityCondition extends AppCompatActivity {
        ...
        webview.setWebViewClient(new WebViewClient() {
            ...
            public void onPageFinished(WebView view, String url) {
                ...
                if (isFirstLoad) {
                    ...
                    int primaryColor = new ContextThemeWrapper(visibilityCondition.this, R.style.Base_Theme_WeatherMaster)
                            .getTheme()
    ...
    public class AndroidFunctionActivityInterface {
        private visibilityCondition mActivity;

        AndroidFunctionActivityInterface(visibilityCondition activity) {
            mActivity = activity;
        }
