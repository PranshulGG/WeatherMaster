...
public class contributorsPage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webview.loadUrl("file:///android_asset/pages/contributors.html");
        ...
        webview.setWebViewClient(new WebViewClient() {
            ...
            public void onPageFinished(WebView view, String url) {
                ...
                if (isFirstLoad) {
                    ...
                    int primaryColor = new ContextThemeWrapper(contributorsPage.this, R.style.Base_Theme_WeatherMaster)
                            .getTheme()
    ...
    public class AndroidFunctionActivityInterface {
        private contributorsPage mActivity;

        AndroidFunctionActivityInterface(contributorsPage activity) {
            mActivity = activity;
        }
    ...
    public class AndroidInterface {
        ...
        AndroidInterface(contributorsPage activity) {
            mActivity = activity;
        }
